...
namespace Q1.Models
{
    public partial class PE_PRN221Context : DbContext
    {
        public PE_PRN221Context()
        {
        }

        public PE_PRN221Context(DbContextOptions<PE_PRN221Context> options)
            : base(options)
        {
        }
        ...
        protected override void OnModelCreating(ModelBuilder modelBuilder)
        {
            ...
            modelBuilder.Entity<EmployeeProject>(entity =>
            {
                entity.HasKey(e => new { e.EmployeeId, e.ProjectId })
                    .HasName("PK__Employee__6DB1E41CD0E09007");
            ...
            modelBuilder.Entity<EmployeeSkill>(entity =>
            {
                entity.HasKey(e => new { e.EmployeeId, e.SkillId })
                    .HasName("PK__Employee__172A46EF30767104");
